...
In many emerging markets, $0.01 actually buys something. We can't build a global micro-economy if the smallest building block is too expensive. Even in a USD context, a $5 monthly budget is exhausted after just 500 page views if each hit costs a cent. We want more money to be sent to pages where we actually spend time.
