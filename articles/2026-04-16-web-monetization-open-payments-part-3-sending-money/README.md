...
In [Part 1](../2025-12-03-web-monetization-open-payments-part-1-connecting-wallet/README.md) of the series, we covered how to link your wallet to the extension and secure the access tokens required for future transactions. In [Part 2](../2025-12-10-web-monetization-open-payments-part-2-connecting-wallet/README.md), we explored the receiving side: identifying a website's receiving wallet addresses via `<link rel="monetization">` and calculating the amounts our wallet can pay into them. Now, we'll combine these elements to actually move money.
