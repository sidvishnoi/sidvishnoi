...
![Illustration showing turning long wallet addresses to custom domain payment pointers](./images/memorable-wallet-addresses-on-own-domain.png)
...
![Screenshot showing Cloudflare dashboard with the Page rule editor showing setup of my domain using a redirect to my GateHub wallet](./images/cloudflare-page-rule.png)
...
![Screenshot of Cloudflare dashboard with a transform rule to support CORS for our wallet address](./images/cloudflare-transform-rule.png)
